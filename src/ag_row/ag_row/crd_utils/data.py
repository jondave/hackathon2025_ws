...
class dataProcess(object):
    def __init__(self, out_rows, out_cols, data_path="./data/train/image", label_path="./data/train/label",
                 test_path="./data/test/image", testlabel_path="./data/test/label", val_path="./data/validation/image", vallabel_path="./data/validation/label", npy_path="./npydata", img_type="jpg"):
    ...
    def load_val_data(self):
        ...
        imgs_val /= 255
        imgs_mask_val /= 255
        imgs_mask_val[imgs_mask_val > 0.5] = 1  # 白
        imgs_mask_val[imgs_mask_val <= 0.5] = 0  # 黑
